...
export default function Sidebar() {
  ...
  return (
    <aside className="border-b border-slate-200/70 bg-white/78 p-4 shadow-panel backdrop-blur dark:border-white/10 dark:bg-slate/72 lg:min-h-screen lg:border-b-0 lg:border-r lg:p-5">
      ...
      <div className="mt-6 rounded-[28px] border border-slate-200/70 bg-slate-50/85 p-3 dark:border-white/10 dark:bg-white/5 lg:mt-8">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                clsx(
                  ...
                  isActive
                    ? "bg-slate-950 text-white shadow-lg shadow-slate-900/10 dark:bg-brand dark:text-ink"
                    : "text-slate-600 hover:bg-white dark:text-slate-200 dark:hover:bg-white/5",
                )
              }
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-slate-900/5 dark:bg-white/5">
                <Icon size={17} />
              </span>
              {item.label}
            </NavLink>
      ...
      <div className="mt-6 rounded-[28px] border border-slate-200/70 bg-white/75 p-4 dark:border-white/10 dark:bg-white/5 lg:mt-8">
